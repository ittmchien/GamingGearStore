...
// 
//     Connection String Name: `GamingGearConnectionString`
//     Provider:               `System.Data.SqlClient`
//     Connection String:      `Data Source=ACER;Initial Catalog=GamingGear;Persist Security Info=True;User ID=sa;Password=3012`
//     Schema:                 ``
//     Include Views:          `False`
...
namespace GamingGearConnectionString
{

	public partial class GamingGearConnectionStringDB : Database
	{
		public GamingGearConnectionStringDB() 
			: base("GamingGearConnectionString")
		{
			CommonConstruct();
		}

		public GamingGearConnectionStringDB(string connectionStringName) 
		...
		{
			GamingGearConnectionStringDB GetInstance();
		}
		
		public static IFactory Factory { get; set; }
        public static GamingGearConnectionStringDB GetInstance()
        {
			if (_instance!=null)
				return _instance;
			...
			if (Factory!=null)
				...
				return new GamingGearConnectionStringDB();
        }

		[ThreadStatic] static GamingGearConnectionStringDB _instance;
		...
		{
			public static GamingGearConnectionStringDB repo { get { return GamingGearConnectionStringDB.GetInstance(); } }
    ...
    public partial class __MigrationHistory : GamingGearConnectionStringDB.Record<__MigrationHistory>  
    {
    ...
    public partial class AspNetRole : GamingGearConnectionStringDB.Record<AspNetRole>  
    {
    ...
    public partial class AspNetUserClaim : GamingGearConnectionStringDB.Record<AspNetUserClaim>  
    {
    ...
    public partial class AspNetUserLogin : GamingGearConnectionStringDB.Record<AspNetUserLogin>  
    {
    ...
    public partial class AspNetUserRole : GamingGearConnectionStringDB.Record<AspNetUserRole>  
    {
    ...
    public partial class AspNetUser : GamingGearConnectionStringDB.Record<AspNetUser>  
    {
    ...
    public partial class GioHang : GamingGearConnectionStringDB.Record<GioHang>  
    {
    ...
    public partial class LoaiSP : GamingGearConnectionStringDB.Record<LoaiSP>  
    {
    ...
    public partial class NSX : GamingGearConnectionStringDB.Record<NSX>  
    {
    ...
    public partial class SanPham : GamingGearConnectionStringDB.Record<SanPham>  
    {
